...
class View {
    ...
    public function fitxerDeTraduccions() {
        if (file_exists("languages/{$this->idioma}_traduccio.php")) {
            return "languages/{$this->idioma}_traduccio.php";
        } else {
            throw new Exception("He tingut problemes al carregar el fitxer de traduccions");
        }
    }
